...
describe('getContext', () => {
  ...
  it('should transform data into correct format if all data provided', () => {
    ...
    expect(organisations[0][0].href).toEqual(`${baseUrl}/organisations/${mockOrganisations[0].organisationId}`);
    ...
    expect(organisations[1][0].href).toEqual(`${baseUrl}/organisations/${mockOrganisations[1].organisationId}`);
