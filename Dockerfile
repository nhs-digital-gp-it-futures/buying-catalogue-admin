...
RUN npx --no-install babel app -d dist/app --copy-files

# Transpile main.js to public/js/main.bundle
RUN npx --no-install babel app/scripts/main.js -o dist/public/js/main.bundle.min.js

# Convert sass into css
RUN npx --no-install node-sass --output-style compressed app/styles/main.scss dist/public/css/main.min.css
